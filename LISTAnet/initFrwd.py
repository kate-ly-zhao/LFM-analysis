...
# python initFrwd.py --outputs-dir "./outputs" --weights-fileF "/home/kz1722/Test/LFMatrixWeightInitG/HTomato3x3Smpl_514_1919.mat"   --weights-fileFl "/home/kz1722/Test/dataweights/epochFl_24.pth"
# python initFrwd.py --outputs-dir "./outputs" --weights-fileF "/home/kz1722/Test/LFMatrixWeightInitG/HTomato3x3Smpl_514_1919.mat"
...
knownW = torch.from_numpy(wg4).to(device) # torch.from_numpy creates tensor
...
Fl_optimizer = optim.Adam(Fl.parameters(), lr=1e-4)#5e-7 # ADAM algorithm (stochastic optimization)
...
for epoch in range(args.num_epochs):
    ...
    with tqdm(total=(lenDatSet - lenDatSet % batch_size), ncols=80) as t:
        ...
        for dummIn in range(numBatch):
            ...
            lfSyntImp=Fl(torch.nn.functional.pad(volImp,(s*(L2-1),s*(L2-1),s*(L2-1),s*(L2-1)))) # Impulse response of linear model Fl()
