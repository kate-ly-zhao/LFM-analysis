...
class multConvFModel(nn.Module): #Forward Model
    ...
    def __init__(self, nDepths=53,s=3,V=51,NxN=361,haarL=8,l=3,c=400):
        ...
        self.convBias=nn.Sequential( # Sequential container, module order maintained (container is treated as module) 
             nn.Conv2d(nDepths*s*s,c,kernel_size=l, bias=False,padding=0,padding_mode='reflect'),
             nn.Conv2d(c,c,kernel_size=l, bias=False,padding=0,padding_mode='reflect'), # Why are there 6 nn.Conv2d(c,c,...)
